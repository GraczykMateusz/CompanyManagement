...
class StartPage(tk.Tk, Page):
    ...
    def __init__(self, geometry="1200x800", background="../Pictures/Background/background.png", icon="../Pictures/Icons/icon.png"):
        ...
        self.add_employee_button("../Pictures/Buttons/employee_add_button.png", 490, self.sub_window.add_employee)
        self.add_employee_button("../Pictures/Buttons/employee_delete_button.png", 550, self.sub_window.delete_employee)
        self.add_employee_button("../Pictures/Buttons/employee_list_button.png", 610, self.sub_window.list_employee)
        self.add_employee_button("../Pictures/Buttons/employee_find_button.png", 670, self.sub_window.find_employee)

        self.add_company_button("../Pictures/Buttons/company_add_button.png", 490, self.sub_window.add_company)
        self.add_company_button("../Pictures/Buttons/company_delete_button.png", 550, self.sub_window.delete_company)
        self.add_company_button("../Pictures/Buttons/company_list_button.png", 610, self.sub_window.list_company)
        self.add_company_button("../Pictures/Buttons/company_find_button.png", 670, self.sub_window.find_company)

        self.add_database_button("../Pictures/Buttons/database_download_button.png", 490, self.sub_window.download_database)
        self.add_database_button("../Pictures/Buttons/database_send_button.png", 550, self.sub_window.send_database)

        self.radio_tip_button()                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   

    def add_employee_button(self, button_image, position_y, event=None):
        position_x=220
    ...
    def add_company_button(self, button_image, position_y, event=None):
        position_x=520
    ...
    def add_database_button(self, button_image, position_y, event=None):
        position_x=820
